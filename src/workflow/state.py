...
class IngestionState(TypedDict):
    ...
    Attributes:
        ...
        document_pages: Per-page documents from loader, preserving page metadata.
    ...
    document_pages: list[Document]  # Per-page documents from loader, preserving page metadata
